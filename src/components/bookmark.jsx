...
const Bookmark=({bookmark, handleBookmark}) => {

    //тут реакт ругается на аттрибут fill у тэга svg, однако приложение не падает. плагин для babel под названием react-html-attrs не помог решить проблему
